...
var Search = require.main.require('./models/Search');   
...
async function list(req, res) { 
    ...
    data = {};    
    action = 'list'; 
    const testdriveList = await Testdrive.getAllData();   
    res.render('admin/testdrive/list',{page_title:" List",data:testdriveList,controller:controller,action:action});    
};       
exports.list = list;
