...
var Smecontact = require.main.require('./models/Smecontact');  
const bcrypt = require('bcrypt');
const saltRounds = 10;
const myPlaintextPassword = 's0/\/\P4$$w0rD';
const someOtherPlaintextPassword = 'not_bacon';  
const controller = 'smecontact'; 
...
async function list(req, res) { 
    ...
    const dataList = await Smecontact.getAllData();   
    res.render('admin/smecontact/list',{page_title:" List",data:dataList,LoginUser:LoginUser,controller:controller,action:action});     
};       
exports.list = list;
