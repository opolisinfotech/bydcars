...
var Supportcontact = require.main.require('./models/Supportcontact');
const bcrypt = require('bcrypt');
const saltRounds = 10;
const myPlaintextPassword = 's0/\/\P4$$w0rD';
const someOtherPlaintextPassword = 'not_bacon';   
const controller = 'supportcontact'; 
...
async function list(req, res) { 
    ...
    const dataList = await Supportcontact.getAllData();   
    res.render('admin/supportcontact/list',{page_title:" List",data:dataList,LoginUser:LoginUser,controller:controller,action:action});    
};       
exports.list = list;
