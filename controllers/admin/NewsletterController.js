...
var Newsletter = require.main.require('./models/Newsletter');
const bcrypt = require('bcrypt');
const saltRounds = 10;
const myPlaintextPassword = 's0/\/\P4$$w0rD';
const someOtherPlaintextPassword = 'not_bacon';    
const controller = 'newsletter'; 
...
async function list(req, res) { 
    ...
    const dataList = await Newsletter.getAllData();   
    res.render('admin/Newsletter/list',{page_title:" List",data:dataList,LoginUser:LoginUser,controller:controller,action:action});     
};       
exports.list = list;
